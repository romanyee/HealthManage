...
//                        }
                    ...
                    if (lTimeNow - lLastTime > 80) {
                        lLastTime = lTimeNow;
                        Message msg = mHandler.obtainMessage(GetData.MESSAGE_READ);
    ...
    private void connectionFailed(int index) {
        ...
        Message msg = mHandler.obtainMessage(GetData.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
    ...
    public synchronized void connected(BluetoothSocket socket,BluetoothDevice device,int index) {
        ...
        Message msg = mHandler.obtainMessage(GetData.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(GetData.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
